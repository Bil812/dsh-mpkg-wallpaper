...
${roundCompat ? `/* ②(新) 第三方插件 UI 圆角兼容：插件注入的内容若有"矩形容器"（有背景但无圆角），
   统一补圆角（不加 !important，插件自己的圆角样式优先）。不局限某个插件。 */
[data-plugin],
[data-plugin] [class*="wrap"],
[data-plugin] [class*="panel"],
[data-plugin] [class*="box"],
[data-plugin] [class*="section"],
[data-plugin] [class*="container"] {
	border-radius: 10px;
}` : ""}
/* ④ 冲突确认弹窗 */
.mpw_mask {
