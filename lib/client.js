...
/* 提问输入框（composer）：虚化开 = 保留 backdrop 模糊，卡片用 mask 衍生色近实底（不再白色）；
...
`;
		...
		function MpkgSection(props) {
			...
			const scanLibrary = async () => {
				...
				try {
					...
					setLibWalls(d.ok && d.wallpapers ? d.wallpapers : []);
			...
			return h("div", { className: "mpw_row" }, [
					...
					libOpen && wallList.length ? h("div", { className: "mpw_props", style: { maxHeight: 260, overflowY: "auto" } }, [
						wallList.slice(0, libShow).map((w, wi) => h("div", { className: "mpw_prop", key: w.key }, [
							...
							h("div", { className: "mpw_inline" }, [
								...
								h("button", { className: "mpw_reset mpw_moreBtn", type: "button", onClick: () => { setWallIdx(wi); applyWallFromList(w); } }, t("lib.use"))
							])
						])),
						...
						? h("div", { className: "mpw_props", style: { maxHeight: 220, overflowY: "auto" } }, [
							libWalls.slice(0, libShow).map((wp, wi) => h("div", { className: "mpw_prop", key: wp.ltoken }, [
								...
								h("div", { className: "mpw_inline" }, [
									...
									h("button", { className: "mpw_reset mpw_moreBtn", type: "button", onClick: () => { setWallIdx(wi); applyLibraryWallpaper(wp); } }, t("lib.use"))
								])
							])),
				...
				dirPick ? h("div", { className: "mpw_mask", onClick: () => setDirPick(false) }, [
					h("div", { className: "mpw_dialog", onClick: (ev) => ev.stopPropagation() }, [
						...
						h("div", { className: "mpw_inline" }, [
							h("button", { className: "mpw_button", type: "button", onClick: () => {
								setCustomDirState(dirPath);
								setDirPick(false);
								commit({ customDirPath: dirPath }, true);
								scanCustomDir();
							} }, t("lib.chooseHere")),
		...
		const zh = {
			...
			"lib.collapse": "收起列表",
			"lib.expandAll": "展开壁纸",
			"lib.rotateDesc": "定时自动切换到下一个壁纸（范围：自定义目录 + 本地库）",
			"lib.rotateMin": "轮换间隔",
			"lib.minutes": "分钟",
		...
		const en = {
			...
			"lib.rotateDesc": "Automatically switch to the next wallpaper on a timer (range: custom folder + local library)",
