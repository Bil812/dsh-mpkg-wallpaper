...
body[data-mpw-float] .wSkVaW_header {
	...
	border-radius: 20px;
	box-shadow: inset 0 1px 0 rgba(255,255,255,0.5), 0 8px 28px rgba(19,45,83,0.1);
}
...
body[data-ds-dark-theme] body[data-mpw-float] .wSkVaW_header {
	...
	border-bottom-color: transparent;
	box-shadow: inset 0 1px 0 rgba(255,255,255,0.07), 0 6px 24px rgba(2,6,14,0.22);
}
