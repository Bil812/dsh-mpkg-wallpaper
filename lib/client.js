				...
				dirPick ? h("div", { className: "mpw_mask", onClick: () => setDirPick(false) }, [
					h("div", { className: "mpw_dialog", onClick: (ev) => ev.stopPropagation() }, [
						...
						h("div", { className: "mpw_inline" }, [
							...
							h("button", { className: "mpw_reset mpw_moreBtn", type: "button", onClick: () => openDirPicker("/sdcard") }, "📱 /sdcard"),
							h("button", { className: "mpw_reset mpw_moreBtn", type: "button", onClick: () => openDirPicker("/storage/emulated/0") }, "📱 /storage"),
