...
`;
				...
				h("div", { className: "mpw_field" }, [
					...
					h("div", { className: "mpw_inline" }, [
						h("input", { className: "mpw_input", type: "text", style: { flex: 1, minWidth: 0 },
							...
							placeholder: "/sdcard/Pictures/壁纸",
		...
		const zh = {
			...
			"lib.scan": "扫描本地壁纸库",
			"lib.desc": "Windows + 壁纸引擎安装时自动发现视频/网页壁纸（.exe 壁纸已安全排除）",
			"lib.use": "使用",
		...
		const en = {
			...
			"lib.desc": "On Windows with Wallpaper Engine installed, discovers video/web wallpapers (.exe wallpapers safely excluded)",
			"lib.use": "Use",
